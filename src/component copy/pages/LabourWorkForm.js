...
import { labourActions } from "../../store/labourWorkReducer";
 ...
 setShow(true)
    instance
      ...
      .then(response=>{
        ...
        if(response.status === 200){
          ...
          dispatch(labourActions.add_labour_work([...labourWork,labourData]));
         setShow(true)
  ...
  return (
    ...
    <div className={classes.labour}>
      ...
      <label>  
<input type='checkbox' name='landPlowing'
// value={landPlowing} 
...
<input type='checkbox' name='landPlowingWithTractor' 
...
<input type='checkbox' name='fertilization' 
//value={fertilization} 
...
<input type='checkbox' name='weedRemoving' 
//value={weedRemoving} 
...
<label>
<input type='checkbox' name='pesticideSpraying' 
...
<label>
<input type='checkbox' name='handHarvesting'
...
<label>
<input type='checkbox' name='cropSpanking'
// value={cropSpanking} 
...
<label>
<input type='checkbox' name='pumpsetDuty' 
//value={pumpsetDuty} 
...
Pumpset duty </label>
 ...
 <label>
<input type='checkbox' name='landCleaning' 
// value={landCleaning} 
...
<label>
<input type='checkbox' name='treeClimbing' 
//value={treeClimbing}
...
<label>
<input type='checkbox' name='paddySteaming' 
//value={paddySteaming}
...
<div >
              ...
              <textarea
                ...
                style={{ height: "150px", width:"400px", marginLeft: '300px', marginTop: '25px' , fontSize: '15px'}}
...
{!show ? <button onClick={submitHandler}>Submit</button> : 
