        ...
        <Layout>
            <div className={classes.login}>
                <form>
                    ...
                    {placeError?<span style={{"color":"red","display":"block","fontSize":"x-small"}}>{placeError}</span>:null}<br/>
                    <label>Type</label>
                    ...
                    {breedError?<span style={{"color":"red","display":"block","fontSize":"x-small"}}>{breedError}</span>:null}<br/>
                    <label>Name</label>
                    ...
                    {seasonError?<span style={{"color":"red","display":"block","fontSize":"x-small"}}>{seasonError}</span>:null}<br/>
