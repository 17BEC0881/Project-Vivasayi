                ...
                <tbody>
                    {farmer.map((input) => (
                        <tr key={input.farmerDetails.farmerId}>
                           ...
                           <td><MdEdit size={15} style={{ margin:"5px" }} onClick={() => editHandler(input.farmerDetails.farmerId)}/>
                           <AiTwotoneDelete size={15} style={{ margin:"5px" }} onClick={(e) => deleteHandler(input.farmerDetails.farmerId)}/></td>
                        </tr>
                    ))}
